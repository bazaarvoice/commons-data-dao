...
import com.bazaarvoice.commons.data.dao.json.JSONTestHelper;
...
public class JSONSchemaMarshallerTest {
    ...
    private void compareSchemaWithResource(JSONSchema schema, String resourceLocation) throws Exception {
        ...
        JSONTestHelper.compareJSONWithResource(schemaJSON, getClass(), resourceLocation, "toJSON");
        JSONSchema schema2 = _jsonSchemaMarshaller.fromJSONObject(schemaJSON);
        JSONTestHelper.compareJSONWithResource(_jsonSchemaMarshaller.toJSONObject(schema2), getClass(), resourceLocation, "fromJSON -> toJSON");
    }
}
